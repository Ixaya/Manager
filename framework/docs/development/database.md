...
Evidence: `framework/docs/design/07-database-drivers/driver-matrix-benchmark.md`
...
before.
Evidence: `framework/docs/design/07-database-drivers/decisions.md`'s "Schema type
...
Evidence: full rationale is `framework/docs/design/07-database-drivers/decisions.md`'s
