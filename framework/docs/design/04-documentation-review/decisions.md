...
framework shape and points at `framework/docs/development/framework-workflow.md`.
...
- **The Docker-only rule states its scope.** It binds `framework/docs/development/` and
...
`framework/docs/development/skill-authoring.md`:
