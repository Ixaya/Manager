...
- Re-verify the `BE_` edit inventory after any upstream Ion Auth merge —
  procedure in `framework/docs/development/auth-upstream.md`.
- Pre-deploy schema gate on the target DB: three `*_selector` columns
  ...
  (migrations `20260213175005_Manager_ion_auth_v2.php` (selectors) and
  `20260213175009_Manager_ion_auth_v3.php` (`salt` drop)).
