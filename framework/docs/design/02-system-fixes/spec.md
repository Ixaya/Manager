...
and from the framework/docs/skills standardization work (2026-07-09). Ran in the
(gitignored, since deleted) `framework/docs/workspace/04-system-migration/` section.
