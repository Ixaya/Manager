...
class Profile extends Private_Controller
{
	...
	public function edit()
	{
		...
		if ($this->input->post('first_name')) {
			...
			if (!empty($result['thumb_image_name'])) {
				...
				$this->amazon_aws_lib->upload_file($relative_path . $result['thumb_image_name']);
				$this->amazon_aws_lib->upload_file($relative_path . $result['fullsize_image_name']);
			}
	...
	public function picture()
	{
		...
		if (!file_exists($file_path)) {
			$this->load->library('amazon_aws_lib');
			$result = $this->amazon_aws_lib->save_file($filename, $relative_path);
	...
	public function test()
	{
		...
		//$this->amazon_aws_lib->upload_file('/home/manager/app/private/user/ef2d3c16686589d1dd8eff7b65a59cc8.jpg');
		//$result = $this->amazon_aws_lib->list_files();
		$result = $this->amazon_aws_lib->save_file('ef2d3c16686589d1dd8eff7b65a59cc8.jpg', '/home/manager/app/private/temp/');
		// print("<pre>");
		// print_r($result);
		// print("</pre>");
	}
