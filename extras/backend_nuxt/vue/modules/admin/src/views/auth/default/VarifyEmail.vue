      ...
      <b-col md="6 p-0">
        <b-card class="card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
          ...
          <div class="d-inline-block w-100">
            <router-link class="btn btn-primary mt-3" :to="{ name: 'default.dashboard' }">Back to Home</router-link>
          </div>
        </b-card>
      </b-col>
      <b-col md="6 d-md-block d-none bg-primary p-0 vh-100 overflow-hidden">
        <img class="img-fluid gradient-main animated-scaleX" src="@/assets/images/auth/03.png" alt="images" loading="lazy" />
      </b-col>
    </b-row>
  </section>
</template>
