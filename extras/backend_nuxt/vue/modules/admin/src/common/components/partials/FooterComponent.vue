<template>
  ...
  <footer :class="`footer ${footerStyle}`">
    <div class="footer-body">
      <ul class="left-panel list-inline mb-0 p-0" style="margin-left: 20px">
        <!-- <li class="list-inline-item"><router-link :to="{ name: 'default.privacy-policy' }">Privacy Policy</router-link></li>-->
        <li class="list-inline-item"><router-link :to="{ name: 'landing-page.terms-and-conditions' }">Términos y Condiciones</router-link></li>
      </ul>
      <div class="right-panel">
        ©{{ date }}
        <span data-setting="app_name"><brand-name></brand-name></span>
        , Hecho con
        ...
        por
        <a href="https://www.ixaya.com/" target="_blank">Ixaya</a>.
      </div>
    </div>
  </footer>
</template>
