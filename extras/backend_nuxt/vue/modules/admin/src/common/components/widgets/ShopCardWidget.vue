  ...
  <div :class="`card iq-product-custom-card animate:hover-media ${className}`">
    <div class="iq-product-hover-img position-relative animate:hover-media-wrap">
      <router-link to="/shop-detail">
        <img class="img-fluid iq-product-img hover-media" :src="`${productImage}`" alt="product-details" loading="lazy" />
      </router-link>
      <div class="hopeui_style-btn-container">
        <router-link class="add_to_cart" to="#">
    ...
    <div class="card-body">
      <div class="d-flex justify-content-between align-items-center mb-2">
        <router-link class="h6 iq-product-detail mb-0" to="/shop-detail">{{ product_name }}</router-link>
