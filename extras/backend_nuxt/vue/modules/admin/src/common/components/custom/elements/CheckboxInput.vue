<template>
  <div :class="className">
    <input class="btn-check" type="checkbox" :value="value" :name="btnName" :id="id" autoComplete="off" :checked="checkboxCheckValue(defaultChecked, value)" @change="$emit('onChange', onCheckboxUpdate(defaultChecked, value), btnName)" />
