<template>
  ...
  <default-sidebar>
    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
      ...
      <side-menu isTag="router-link" title="Usuarios" icon="user-group" :route="{ to: 'default.user-list' }"></side-menu>
      <side-menu isTag="router-link" title="Example" icon="file" :route="{ to: 'default.example-list' }"></side-menu>
...
import DefaultSidebar from '@/common/components/custom/sidebar/DefaultSidebar.vue'
import SideMenu from '@/common/components/custom/nav/SideMenu.vue'
export default {
