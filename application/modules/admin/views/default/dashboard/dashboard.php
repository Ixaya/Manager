				...
				<div class="panel panel-white">
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-9 text-right">
								<a :href="webpage | webpage.slug">
									<div> {{webpage.title}}</div>
								</a>
		...
		new Vue({
			...
			watch: {
				page_items_count: function(newValue) {
					gsap.to(this.$data, {
						duration: 1,
						tweened_page_items_count: newValue
					});
				},
				webpages_count: function(newValue) {
					gsap.to(this.$data, {
						duration: 1,
						tweened_webpages_count: newValue
					});
				},
				...
				dashboard_poll: function() {
					...
					axios
						...
						.then(response => (
							...
							this.webpages_count = response.data.response.webpages_count,
