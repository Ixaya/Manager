...
//             $userEmail = $userFacebookID;
    ...
    private function sync_user_image($id)
    {
	    ob_start();
	    $ch = curl_init();
	    ...
	    $headers = array (
		    ...
		    'X-API-KEY: gk4o88g0k4o0044o48o00skgcwc0cw8ks08ogg04'
		);
		
		curl_setopt($ch, CURLOPT_URL,"https://vps98.ixaya.net/api/profiles/sync_facebook_image/id/$id");
...
// 		$this->print_log(array('method' => 'sync_user_image', 'output' => $server_output, 'extra' => $info));
		$this->print_log(array('method' => 'sync_user_image', $server_output));
