...
class Format
{
	 ...
	 * @param mixed|null $data Optional data to pass, so as to override the data passed
	 * to the constructor
	 * @param string|null $delimiter The optional delimiter parameter sets the field
	 * delimiter (one character only). NULL will use the default value (,)
	 * @param string|null $enclosure The optional enclosure parameter sets the field
	 * enclosure (one character only). NULL will use the default value (")
	 * @return string|null A csv string
	 */
	 ...
	 * @return array Parsed XML as an associative array, or empty array on failure
	 */
	...
	/**
	 * @param string $data Data to unserialized
