...
class Migration_Manager_attachment_v2 extends MGR_Migration_builder
{
	protected $table_name = 'attachment';

	public function up()
	{
		$this->dbforge->modify_column($this->table_name, [
	...
	public function down()
	{
		...
		$this->modify_field_timestamp(table: $this->table_name, column: 'create_date', on_update: false, default: false);
