...
if (!function_exists('mgr_generate_hash')) {
	/**
...
if (!function_exists('mgr_format_hash')) {
	/**
...
if (!function_exists('mgr_unformat_hash')) {
	/**
...
if (!function_exists('mgr_process_exception')) {
	/**
...
if (!function_exists('mgr_cache_key')) {
	/**
...
if (!function_exists('mgr_build_limit_page')) {
	/**
...
if (!function_exists('mgr_build_order_by')) {
	/**
...
if (!function_exists('mgr_validate_order_by')) {
	/**
