...
if (!function_exists('mgr_date_default_timezone_set')) {
	/**
...
if (!function_exists('mgr_get_time_zone_offset')) {
	/**
...
if (!function_exists('mgr_get_now_date_time')) {
	/**
...
if (!function_exists('mgr_get_now_date_time_sql_format')) {
