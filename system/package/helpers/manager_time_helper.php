...
if (!function_exists('mgr_get_date_option_obj')) {
...
if (!function_exists('mgr_get_date_option_unix')) {
...
if (!function_exists('mgr_get_date_option')) {
...
if (!function_exists('mgr_create_date_time')) {
	/**
...
if (!function_exists('mgr_format_date_time_iso')) {
	/**
...
if (!function_exists('mgr_format_date_time_sql')) {
	/**
...
if (!function_exists('mgr_to_unix')) {
	/**
