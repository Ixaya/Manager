...
if (!function_exists('mgr_file_path')) {
	/**
...
if (!function_exists('mgr_private_file_path')) {
	/**
...
if (!function_exists('mgr_app_file_path')) {
	/**
...
if (!function_exists('mgr_clean_file_path')) {
	/**
...
if (!function_exists('mgr_clean_file_s3_path')) {
	/**
...
if (!function_exists('mgr_get_temp_upload_path')) {
	/**
...
if (!function_exists('mgr_get_temp_upload_path_key')) {
	/**
...
if (!function_exists('mgr_get_temp_upload_paths')) {
	/**
